...
import pygame
from config import SCREEN_HEIGHT, SCREEN_WIDTH, BALL_SPEED, BALL_SIZE, PLAYER_SPEED
import random
from global_stuff import players
    ...
    def update(self):
        ...
        if paddle:
            ...
            if pygame.sprite.spritecollideany(self, players):
                ...
                self.BallSpeedY = self.BallSpeedY * 1.1
                player1.PlayerSpeed = player1.PlayerSpeed * 1.1
                player2.PlayerSpeed = player2.PlayerSpeed * 1.1
